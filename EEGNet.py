...
if __name__ == '__main__':
    ...
    # Load Training Data
    #sys.path.append('../Dropbox/NEDE_Dropbox/Data/training_v6')

    data = sp.io.loadmat('../Dropbox/NEDE_Dropbox/Data/training_v6/training_data.mat')
    ...
    for cv in range(10):
        ...
        for i in [1]:        
            ...
            if run_combined:
                ...
                weightsfilename = 'weights/test/CombinedModelWeights_fold' + str(i) +'.hf5'
            ...
            if run_eeg:
                EEGnet = EEGNet(type = 'VR')
                weightsfilename = 'weights/test/EEGModelWeights_fold' + str(i) +'.hf5'
                checkpointer = ModelCheckpoint(filepath = weightsfilename, verbose=0,
                                               save_best_only = True)
            ...
            if run_head:
                EEGnet = EEGNet(type = 'VR')
                weightsfilename = 'weights/test/HeadModelWeights_fold' + str(i) +'.hf5'
                checkpointer = ModelCheckpoint(filepath = weightsfilename, verbose=0,
                                               save_best_only = True)
            ...
            if run_pupil:
                EEGnet = EEGNet(type = 'VR')
                weightsfilename = 'weights/test/PupilModelWeights_fold' + str(i) +'.hf5'
                checkpointer = ModelCheckpoint(filepath = weightsfilename, verbose=0,
                                               save_best_only = True)
            ...
            if run_dwell:
                EEGnet = EEGNet(type = 'VR')
                weightsfilename = 'weights/test/DwellModelWeights_fold' + str(i) +'.hf5'
                checkpointer = ModelCheckpoint(filepath = weightsfilename, verbose=0,
                                               save_best_only = True)
        ...
        sp.io.savemat('results/results_jon_r5_125_1.mat',results)
